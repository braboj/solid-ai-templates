...
| hypermedia | 1 | `stack-htmx` — 305K chars | ~87K tokens | 128K |
| library | 3 | `stack-python-lib` — 388K chars | ~111K tokens | 200K |
| static | 2 | `stack-tutorial` — 425K chars | ~121K tokens | 200K |
<!-- /generated:readme-model-limits -->
