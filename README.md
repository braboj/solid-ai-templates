...
|----------------|--------|---------------|--------|-------------|
| abstract | 2 | `stack-python-service` — 503K chars | ~144K tokens | 200K |
| backend | 8 | `stack-django` — 517K chars | ~148K tokens | 200K |
...
| static | 2 | `stack-tutorial` — 465K chars | ~133K tokens | 200K |
<!-- /generated:readme-model-limits -->
