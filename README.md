...
|----------------|--------|---------------|--------|-------------|
| abstract | 2 | `stack-python-service` — 468K chars | ~134K tokens | 200K |
| backend | 8 | `stack-django` — 482K chars | ~138K tokens | 200K |
| embedded | 1 | `stack-c-embedded` — 287K chars | ~82K tokens | 128K |
| hypermedia | 1 | `stack-htmx` — 311K chars | ~89K tokens | 128K |
| library | 3 | `stack-python-lib` — 394K chars | ~112K tokens | 200K |
| static | 2 | `stack-tutorial` — 430K chars | ~123K tokens | 200K |
<!-- /generated:readme-model-limits -->
