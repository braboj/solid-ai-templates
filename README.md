...
|----------------|--------|---------------|--------|-------------|
| abstract | 2 | `stack-python-service` — 495K chars | ~142K tokens | 200K |
| backend | 8 | `stack-django` — 510K chars | ~146K tokens | 200K |
| embedded | 1 | `stack-c-embedded` — 303K chars | ~86K tokens | 128K |
| hypermedia | 1 | `stack-htmx` — 326K chars | ~93K tokens | 128K |
| library | 3 | `stack-python-lib` — 421K chars | ~120K tokens | 200K |
| static | 2 | `stack-tutorial` — 458K chars | ~131K tokens | 200K |
<!-- /generated:readme-model-limits -->
