...
|----------------|--------|---------------|--------|-------------|
| abstract | 2 | `stack-python-service` — 512K chars | ~146K tokens | 200K |
| backend | 8 | `stack-django` — 526K chars | ~150K tokens | 200K |
| embedded | 1 | `stack-c-embedded` — 315K chars | ~90K tokens | 128K |
| hypermedia | 1 | `stack-htmx` — 338K chars | ~97K tokens | 128K |
| library | 3 | `stack-python-lib` — 438K chars | ~125K tokens | 200K |
| static | 2 | `stack-tutorial` — 473K chars | ~135K tokens | 200K |
<!-- /generated:readme-model-limits -->
